<div class="card card-availability border border-gray-lighter ">
    <div class="card-body text-gray-dark text-center p-0">
        ...
        <div class="content-availability">
            ...
            <input type="hidden" name="lugar" value="{{$plan->title}}">
            ...
            <div class="input-group mb-3">
                ...
                {{Form::text('fecha',null,['id'=>'datepicker', 'class'=>'form-control pl-0','required' => 'required','placeholder'=>'Fecha de Salida', 'aria-label'=>'dd/mm/aa', 'aria-describedby'=>'fecha1'])}}
            </div>
