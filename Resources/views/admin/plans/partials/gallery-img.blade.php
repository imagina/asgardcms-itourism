...
<div class="col-md-12">
  <div class="box">
    ...
    <div style="padding:0 15px 20px">
      <form id="{{$field['name']}}-dropzone" class="dropzone" enctype="multipart/form-data" action="{{route('itourism.gallery.upload')}}" method="post">
        <div class="row">
          <h4 style="text-align: center;">{!!$field['label_drag']!!}<i
            ...
            <div class="dz-message"><span class="h4">{!!$field['label_click']!!}</span></div>
            ...
            <div class="dropzone-previews" id="{{$field['name']}}Preview">
              ...
              <div class="dz-preview dz-processing dz-image-preview dz-complete">
                ...
                onclick="$.deleteFile(this)" dir-data="{{$image}}">{{ trans('itourism::plans.gallery.delete') }}</a>
              </div>
              @endforeach
            </div>
